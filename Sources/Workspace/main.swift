...
//
// MM4
// - 2025-cleanups branch
// - Ensure the Metal plugin does *not* exist
// - Rework the testing script to simply download an OpenMM binary, exclude
//   .dll, .exp, .lib, .dylib from the .gitignore. But do not exclude
//   gfnff_topo or gfnff_charges, because those will never be generated by any
//   of the repository's dependencies.
