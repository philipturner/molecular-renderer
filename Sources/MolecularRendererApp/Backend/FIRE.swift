...
// This is a FIRE energy minimizer for rigid body mechanics.
//
// The primary purpose is to minimize the vdW potential energy of a scene. It
// uses a 2 nm cutoff, which should be sufficient for a rough approximation
// (more accurate dynamics simulations can use 3 nm, but these are separate
// from minimization).
//
