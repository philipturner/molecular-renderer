...
class RayTracing {
public:
  static IntersectionResult traverseDenseGrid(Ray ray, DenseGrid grid)
  {
    ...
    while (dda.continue_loop) {
      ...
      // TODO: Support a cutoff that forces AO rays to eventually quit. Last
      // time I tried it, the cutoff made everything much slower, not sure why.
    }
