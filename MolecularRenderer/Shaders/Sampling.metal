...
#define PRIME_PERM_COUNT 360
  ...
  // bits
  constant uint prime_permTN2[PRIME_PERM_COUNT] = {
...
public:
  ...
  static uint get_prime(uint prime_perm) { return prime_perm & 0xFFFF; }
  
  static uint get_permTN2(uint prime_perm) { return prime_perm >> 16; }
  
  // Faure-Lemieux scrambled radical inverse
  static float radinv_fl(uint n, uint dim) {
