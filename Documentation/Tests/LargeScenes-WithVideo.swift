...
let desiredAtomCount: Int = 2_000_000  // Reduced for GIF generation to avoid BVH limits
...
let loadingSpeed: Int = 2  // Reduced loading speed for GIF generation
...
let gifFrameSkipRate: Int = 3  // Save every 3rd frame for 30 FPS GIF

let gifWidth = renderingOffline ? 1440 : 1440 * 3
let gifHeight = renderingOffline ? 1440 : 1440 * 3
...
print("Recording large scenes animation offline - will save as GIF...")
...
let filePath = "Art/large-scenes.gif"
